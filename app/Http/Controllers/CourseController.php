...
return view('admin.pages.course',compact('data'));
    ...
    function store(Request $request){
        ...
        try{
            ...
            $course->fullNameCourse=$request->fullNameCourse;
            $course->Admission_Process=$request->Admission_Process;
            $course->Duration=$request->Duration;
            $course->Exam_Type=$request->Exam_Type;
            $course->Course_Fee=$request->Course_Fee;
            $course->list_of_course=is_array($request->list_of_course) ? implode(',', $request->list_of_course) : $request->list_of_course;
            ...
            $course->syllabus = is_array($request->syllabus) ? implode(',', $request->syllabus) : $request->syllabus;
            $course->Jobs = is_array($request->Jobs) ? implode(',', $request->Jobs) : $request->Jobs;
