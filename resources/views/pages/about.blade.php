...
@section('content')
    <div class="rts-bread-crumbarea-1 rts-section-gap2 bg_image"
        style="background:url(assets/images/header3.jpg) center center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="about-one-left-image">
                        <div class="first-order">
                            <div class="thumb-one">
                                <img src="assets/images/about-bg-blue.jpg" alt="about">
                ...
                <div class="col-xl-6 col-lg-12 pl--60 pl_md--10 pl_sm--10 pt--50">
                    <div class="title-area-left-style">
                        ...
                        <p class="post-title">Sikshanation is an online platform dedicated to helping students find
                            colleges and universities in India. Our mission is to simplify the complex process of higher
                            education selection by providing comprehensive information and resources to students,
                            parents, and educators.</p>
                        <p class="post-title"> We understand that choosing the right college or university is a crucial
                            decision that can significantly impact one's academic and professional future. Therefore, we
                            strive to offer accurate, up-to-date information about various educational institutions
                            across India, including their programs, admission requirements, faculty, facilities, and
                            more.</p>
                    </div>
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets/images/01.png" alt="icon-image">
                                </div>
                                <div class="information">
                                    <h5 class="title">Free Counselling by Experts </h5>
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="assets/images/02.png" alt="icon-image">
                                </div>
                                <div class="information">
                                    <h5 class="title">100 + Approved (Only UGC-DEB)</h5>
                                    <p>Regular & Distance Education Colleges & Universities Listed on Sikshanation</p>
                                </div>
                            </div>
                            <!-- single-facilities end -->
                        </div>
                ...
                <div class="col-xl-12 col-lg-12">
                    <p class="post-title"> Our platform features a user-friendly interface that allows students to search for colleges and universities based on their preferences, such as location, field of study, accreditation, and budget. We also provide valuable insights and guidance through articles, blog posts, and expert advice to help students make informed decisions about their educational journey.</p>
                    <p class="post-title"> At Sikshanation, we believe in empowering students to pursue their academic aspirations by connecting them with the right educational opportunities. Whether you're exploring undergraduate programs, postgraduate studies, or professional courses, Sikshanation is your trusted partner in navigating the vast landscape of higher education in India.</p>
                </div>
            </div>
        </div>
    </div>
