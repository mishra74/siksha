...
<body>
    ...
    <div class="rts-bread-crumbarea-1 rts-section-gap2 bg_image"
        style="background:url(assets/images/header5.jpg) center center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        ...
                        <div class="pagination-wrapper">
                            ...
                            <a class="active" href="#">Enquiry Now</a>
                        </div>
    ...
    <div class="">
        <div class="container-2">
            <div class="row">
                <div class="col-lg-12">
                 <div class="becom-an-instructor-form-area pl--120 pr--120 pl_sm--10 pr_sm--10">
                        <form action="#" class="instructor-form">
                            <h5 class="title">Enquiry Now</h5>
                            <p class="disc">Explore Your Educational Journey : Inquiry Now!</p>
                            ...
                            <button class="rts-btn btn-primary mb--30">Submit</button>
                        </form>
                    </div>
